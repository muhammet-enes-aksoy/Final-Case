...
{
    public const string DefaultContactAlreadyExistsForCustomerId = "A default contact already exists for the user id: {0}";
    ...
    public const string CustomerIdIsRequired = "User id is required";
}